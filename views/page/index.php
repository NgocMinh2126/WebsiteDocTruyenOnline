<?php
    ...
    if(!$conn){
        ...
        $sqlTieuthuyet="SELECT * FROM Truyen where LoaiTruyen='1' ORDER BY LuotLike desc";
        $resultTieuThuyet=mysqli_query($conn,$sqlTieuthuyet);
        $Tieuthuyetarr=mysqli_fetch_all($resultTieuThuyet,MYSQLI_ASSOC);
        mysqli_free_result($resultTieuThuyet);
        mysqli_close($conn);
    }
?>
...
<body>
    ...
    <main>
        ...
        <div class="main-dstruyen">
            ...
            <div class="main-dstruyen-detail">
                <?php for ($i=0;$i<10;$i++) { $tieuthuyet=$Tieuthuyetarr[$i] ?>
                <a href="#" class="main-dstruyen-detail-a">
                    <img src="<?php echo htmlspecialchars($tieuthuyet['AnhBia'])?>" class="main-dstruyen-img">
                    <div class="main-dstruyen-detail-tentruyen"><?php echo htmlspecialchars($tieuthuyet['TenTruyen'])?></div>
                </a>
                <?php } ?>
            </div>
        </div>
            ...
            <div class="main-moicapnhat-content">
                ...
                <div class="main-moicapnhat-content-detail">
                    <div class="container-flex">
                        <a href="#" class="detail-truyen-img"><img src="/TMTManga/assets/image/imgTruyen/imgHaomonthiengioitienthe.PNG"></a>
